class Dismantle_gunwalldisplay_metal_mung extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Dismantle Gun Wall";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"gunwalldisplay_metal_mung");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("gunwall_metal_kit_mung");//add results here
