class CraftMolotovMung extends RecipeBase	
{	
	override void Init()
	{
		m_Name = "Craft Molotov cocktail";
		...
		InsertIngredient(1,"vodka_mung");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("molotov_mung");//add results here
