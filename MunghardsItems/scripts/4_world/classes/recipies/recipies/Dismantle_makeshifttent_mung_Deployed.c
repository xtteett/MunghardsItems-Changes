class Dismantle_makeshifttent_mung_Deployed extends RecipeBase
{	
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"makeshifttent_mung_Deployed");//you can insert multiple ingredients this way
