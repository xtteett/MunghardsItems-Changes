class Dismantle_gunwalldisplay_mung extends RecipeBase
{	
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"gunwalldisplay_mung");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("gunwall_kit_mung");//add results here
