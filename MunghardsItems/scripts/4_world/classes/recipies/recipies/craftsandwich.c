class craftsandwich extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Make a sandwich";
		...
		InsertIngredient(0,"Edible_Base");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"wonderbread_mung");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("sandwich_mung");//add results here
