class Dismantle_makeshifttent2_mung_Deployed extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Dissmantle shelter";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"makeshifttent2_mung_Deployed");//you can insert multiple ingredients this way
