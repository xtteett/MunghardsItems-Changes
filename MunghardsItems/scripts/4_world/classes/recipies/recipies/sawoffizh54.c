class SawoffShotgunIzh54 extends RecipeBase
{   
    override void Init()
    {
        m_Name = "Saw off Izh54";
        ...
        //INGREDIENTS
        //ingredient 1
        InsertIngredient(0,"izh54_mung");//you can insert multiple ingredients this way
    ...
    {
        MiscGameplayFunctions.TurnItemIntoItemEx(player, new TurnItemIntoItemLambda(ingredients[0], "izh54_sawnoff_mung", player));
    }
};
