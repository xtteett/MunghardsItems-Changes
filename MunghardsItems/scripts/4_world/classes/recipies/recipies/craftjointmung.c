class CraftJointMung extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Roll Joint";
		...
		//ingredient 2
		InsertIngredient(1,"RollingPapers_Jest");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("joint_mung");//add results here
